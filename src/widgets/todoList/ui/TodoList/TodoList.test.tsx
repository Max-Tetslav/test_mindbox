...
import { fakeCompletedTodo, fakeTodoList } from '@entities/todo';
import { TODO_TYPES, type Todos } from '@entities/todo';

import TodoList from './TodoList';
import { EMPTY_TODO_GENERAL_LIST_TEXT } from '../../model/constants';
